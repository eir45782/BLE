...
public class fragment_two extends Fragment implements View.OnClickListener {
    ...
    public void TextViewInitial(){
        fragment_2 = (TextView) fragmentView.findViewById(R.id.fragment_two);

    }

    //BUTTON宣告放這
    public void ButtonInitial(){
        button_2 = (Button) fragmentView.findViewById(R.id.button);
